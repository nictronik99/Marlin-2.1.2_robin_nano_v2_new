...
#define STRING_CONFIG_H_AUTHOR "(Nico, Personalized Anet A8)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MKS_ROBIN_NANO_V2 //mod
#endif
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 12.95 //mod
    #define DEFAULT_Ki 0.70  //mod
    #define DEFAULT_Kd 60.08  //mod
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 35.87  //mod
  #define DEFAULT_bedKi 5.98  //mod
  #define DEFAULT_bedKd 143.50  //mod
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 97 } //mod
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 100, 100, 5, 20 } //mod
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 50, 5000 } //mod
 ...
 */
#define DEFAULT_ACCELERATION          1000    // X, Y, Z and E acceleration for printing moves //mod
#define DEFAULT_RETRACT_ACCELERATION  2000    // E acceleration for retracts //mod
#define DEFAULT_TRAVEL_ACCELERATION   1000    // X, Y, Z acceleration for travel (non printing) moves //mod
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.017 //mod // (mm) Distance from real junction edge
...
#define USE_PROBE_FOR_Z_HOMING //mod
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -19.4, -46, -4.13 } //mod
...
#define Z_HOMING_HEIGHT  6  //mod      // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
                                  // Be sure to have this much clearance over your Z_MAX_POS to prevent grinding.

#define Z_AFTER_HOMING  10  //mod     // (mm) Height to move to after homing Z
...
#define X_BED_SIZE 220 //mod
#define Y_BED_SIZE 220 //mod

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -39.5   //mod
#define Y_MIN_POS -9    //mod
#define Z_MIN_POS 0    //mod 
#define X_MAX_POS 230
#define Y_MAX_POS Y_BED_SIZE
#define Z_MAX_POS 250   //mod
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
 ...
 */
#define DEBUG_LEVELING_FEATURE //mod
...
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
  ...
  #define EEPROM_AUTO_INIT //mod  // Init EEPROM automatically on any errors.
  #define EEPROM_INIT_NOW   //mod // Init EEPROM on first boot after a new build.
#endif
...
//
#define PREHEAT_1_LABEL       "PLA" //mod
#define PREHEAT_1_TEMP_HOTEND 190
#define PREHEAT_1_TEMP_BED     55
//#define PREHEAT_1_TEMP_CHAMBER 35
#define PREHEAT_1_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_2_LABEL       "PETG" //mod
...
// :[0,1,2,3,4,5,6,7]
#define SOFT_PWM_SCALE 0 //mod

// If SOFT_PWM_SCALE is set to a value higher than 0, dithering can
// be used to mitigate the associated resolution loss. If enabled,
// some of the PWM cycles are stretched so on average the desired
// duty cycle is attained.
#define SOFT_PWM_DITHER //mod
